...
extern "C" __global__
    __launch_bounds__(CK_PARAM_TUNABLE_BLOCK_SIZE, 2) void gridwise_convolution_backward_weights_implicit_gemm_v4r4_gen_xdlops_nchw_kcyx_nkhw_fp16(
        const FLOAT* const __restrict__ p_in_global,
        const FLOAT* const __restrict__ p_wei_global,
        FLOAT* const __restrict__ p_out_global)
{
#if (!(MIOPEN_USE_FP16 || MIOPEN_USE_BFP16)) || (CK_PARAM_PROBLEM_DIRECTION != 2)
    static_assert(false, "wrong! Only fp16 and bfp16 are supported.");
